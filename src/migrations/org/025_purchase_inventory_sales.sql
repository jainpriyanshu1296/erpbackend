...
ALTER TABLE purchase_requisitions ADD COLUMN department VARCHAR(100) NULL;
ALTER TABLE purchase_requisitions ADD COLUMN warehouse_id VARCHAR(36) NULL;
ALTER TABLE purchase_requisitions ADD COLUMN required_date DATE NULL;
ALTER TABLE purchase_requisitions ADD COLUMN priority VARCHAR(30) DEFAULT 'normal';
ALTER TABLE purchase_requisitions ADD COLUMN reason TEXT NULL;
ALTER TABLE purchase_requisitions ADD COLUMN rejection_reason VARCHAR(500) NULL;
...
ALTER TABLE purchase_orders ADD COLUMN delivery_date DATE NULL;
ALTER TABLE purchase_orders ADD COLUMN warehouse_id VARCHAR(36) NULL;
ALTER TABLE purchase_orders ADD COLUMN payment_terms INT DEFAULT 30;
ALTER TABLE purchase_orders ADD COLUMN notes TEXT NULL;
...
ALTER TABLE grn ADD COLUMN warehouse_id VARCHAR(36) NULL;
ALTER TABLE grn ADD COLUMN notes TEXT NULL;
...
ALTER TABLE quotations ADD COLUMN valid_until DATE NULL;
ALTER TABLE quotations ADD COLUMN notes TEXT NULL;
ALTER TABLE quotations ADD COLUMN created_by VARCHAR(36) NULL;
...
ALTER TABLE sales_orders ADD COLUMN delivery_date DATE NULL;
ALTER TABLE sales_orders ADD COLUMN notes TEXT NULL;
ALTER TABLE sales_orders ADD COLUMN created_by VARCHAR(36) NULL;
...
ALTER TABLE delivery_challans ADD COLUMN so_id VARCHAR(36) NULL;
ALTER TABLE delivery_challans ADD COLUMN warehouse_id VARCHAR(36) NULL;
ALTER TABLE delivery_challans ADD COLUMN notes TEXT NULL;
ALTER TABLE delivery_challans ADD COLUMN created_by VARCHAR(36) NULL;
...
ALTER TABLE invoices ADD COLUMN so_id VARCHAR(36) NULL;
ALTER TABLE invoices ADD COLUMN notes TEXT NULL;
ALTER TABLE invoices ADD COLUMN created_by VARCHAR(36) NULL;
...
ALTER TABLE sales_returns ADD COLUMN so_id VARCHAR(36) NULL;
ALTER TABLE sales_returns ADD COLUMN warehouse_id VARCHAR(36) NULL;
ALTER TABLE sales_returns ADD COLUMN reason TEXT NULL;
...
ALTER TABLE vendors ADD COLUMN bank_account VARCHAR(100) NULL;
ALTER TABLE vendors ADD COLUMN bank_ifsc VARCHAR(20) NULL;
ALTER TABLE vendors ADD COLUMN credit_limit DECIMAL(14,2) DEFAULT 0;

-- Add missing columns to customers
ALTER TABLE customers ADD COLUMN credit_limit DECIMAL(14,2) DEFAULT 0;
ALTER TABLE customers ADD COLUMN discount_percent DECIMAL(5,2) DEFAULT 0;
